...
HHC is fully active (100\% of samples) with only 2 closed-loop controller interventions needed,
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{figures/boundary_analysis.pdf}
